...
public class BiomeBackportClientEvents {
    ...
    public static void EntityRenderersEvent$RegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        EntityRenderers.register(EntityRegistry.CHERRY_BOAT.get(), (manager) -> new ModBoatRenderer(manager, "cherry", false));
        EntityRenderers.register(EntityRegistry.CHERRY_BOAT_CHEST.get(), (manager) -> new ModBoatRenderer(manager, "cherry", true));
