...
public class ModChestBoatItem extends Item {
    ...
    private final RegistryObject<EntityType<ModChestBoatEntity>> boat;

    public ModChestBoatItem(Properties properties, RegistryObject<EntityType<ModChestBoatEntity>> boat) {
        super(properties);
        this.boat = boat;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player playerIn, InteractionHand handIn) {
        ...
        if (raytraceresult.getType() == HitResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == HitResult.Type.BLOCK) {
                ModChestBoatEntity boatEntity = boat.get().create(level);
